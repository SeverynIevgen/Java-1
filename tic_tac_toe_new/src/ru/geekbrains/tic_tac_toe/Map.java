...
public class Map extends JPanel {
    ...
    //Messages
    private static final String DRAW_MSG = "Not bad) Draw!";
    private static final String PLAYER_1_WIN_MSG = "Player 1 win!";
    private static final String PLAYER_2_WIN_MSG = "Player 2 win!";
    ...
    private void showGameOverMsg(Graphics g) {
        ...
        switch (gameState) {
            case DRAW:
                g.drawString(DRAW_MSG, 95, getHeight() / 2);
                break;
            case WIN_PLAYER_1:
                g.drawString(PLAYER_1_WIN_MSG, 120, getHeight() / 2);
                break;
            case WIN_PLAYER_2:
                g.drawString(PLAYER_2_WIN_MSG, 120, getHeight() / 2);
        }
    }
